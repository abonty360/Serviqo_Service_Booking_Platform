...
<body class="bg-white text-gray-800">
    ...
    <nav class="flex items-center justify-between px-8 py-4 bg-white border-b sticky top-0 z-50">
        ...
        <div class="flex space-x-4">
            ...
            <button onclick="toggleModal('registerModal')" class="px-5 py-2 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 shadow-md transition">Sign Up</button>
        </div>
    </nav>
                ...
                <div class="bg-white px-8 pt-10 pb-8">
                    ...
                    <div class="mt-8 text-center border-t border-gray-100 pt-6">
                        <p class="text-gray-600">Don't have an account? 
                            <button onclick="toggleModal('loginModal'); toggleModal('registerModal')" class="font-bold text-green-600 hover:text-green-700">Create Account</button>
                        </p>
                    </div>
                </div>
    ...
    <!-- Register Modal -->
    <div id="registerModal" class="fixed inset-0 z-[100] hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 transition-opacity bg-gray-900 bg-opacity-75" aria-hidden="true" onclick="toggleModal('registerModal')"></div>
            <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-green-100">
                <div class="bg-white px-8 pt-10 pb-8">
                    <div class="text-center mb-8">
                    ...
                    <form id="registerForm" action="/" method="GET" class="space-y-4" onsubmit="return validatePasswords()">
                    ...
                    <div class="mt-8 text-center border-t border-gray-100 pt-6">
                        <p class="text-gray-600">Already have an account? 
                            <button onclick="toggleModal('registerModal'); toggleModal('loginModal')" class="font-bold text-green-600 hover:text-green-700">Login Now</button>
                        </p>
                    </div>
                </div>
                <button onclick="toggleModal('registerModal')" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition">
                    <i class="fas fa-times text-xl"></i>
                </button>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Page loaded, checking for signup status...');
            const urlParams = new URLSearchParams(window.location.search);
            if (urlParams.get('signup') === 'success') {
                console.log('Signup success detected! Opening login modal...');
